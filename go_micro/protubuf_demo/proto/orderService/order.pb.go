...
type Order struct {
	...
	AddTime string  `protobuf:"bytes,6,opt,name=addTime,proto3" json:"addTime,omitempty"` //message可以嵌套
	// message OrderItem{
	// int64 goodsId=1;
	// string title=2;
	// double price=3;
...
var file_order_proto_rawDesc = []byte{
	...
	0x6d, 0x22, 0x51, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x18,
